...
for i in range(len(courselinks1)):
    ...
    linkwithspace = courselinkss[:end + 1] + "?join:@ProjectHackfreaks&" + courselinkss[end + 2:]
    print(linkwithspace)
    print("")
